              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2">
                  ...
                  <Tabs defaultValue="events" className="w-full">
                    ...
                    <TabsContent value="events">
                      {exhibition.liveEvents?.length > 0 ? (
                    ...
                    <TabsContent value="tours">
                      {exhibition.upcomingTours?.length > 0 ? (
                        <div className="space-y-3">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="mb-4 flex items-start">
                    <Calendar size={18} className="mt-0.5 text-santaran-vermilion mr-3" />
                    <div>
                  ...
                  <div className="mb-4 flex items-start">
                    <MapPin size={18} className="mt-0.5 text-santaran-vermilion mr-3" />
                    <div>
                  ...
                  {exhibition.openingHours && (
                    <div className="mb-4 flex items-start">
                      <Clock size={18} className="mt-0.5 text-santaran-vermilion mr-3" />
                      <div>
                  ...
                  {exhibition.ticketPrice && (
                    <div className="mb-4 flex items-start">
                      <Ticket size={18} className="mt-0.5 text-santaran-vermilion mr-3" />
                      <div>
                  ...
                  <div className="mt-6 p-3 bg-santaran-cream/50 rounded-lg flex items-start">
                    <Info size={18} className="mt-0.5 text-santaran-amber mr-2" />
                    <p className="text-xs">Please arrive 15 minutes early. Photography is permitted without flash.</p>
                  </div>

                  <div className="mt-6">
                    <Button className="w-full">Reserve Your Visit</Button>
                  </div>
                </div>
              </div>
            </div>
...
// Prop validation
ExhibitionDetailModal.propTypes = {
